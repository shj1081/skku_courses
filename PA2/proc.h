...
struct proc {
  ...
  // for CFS
  uint time_slice;              // Time slice of the process (by militicks)
  uint current_runtime;          // Actual runtime of the process (by militicks)
  uint weight;                  // Weight of the process (get from hard-coded value)
